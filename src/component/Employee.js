...
const contacturl = "http://localhost:5247/api/ContactInformation/CreateContactInformation";
const [contacts, setContact]  = useState( {
  ...
  function saveContact(e) { 
    ...
    axios.post(contacturl,
    {
      ...
      alternateaddress: contacts.alternateaddress,
  ...
  const Emrgcyurl = "http://localhost:5247/api/EmergencyInformation/CreateEmergencyInformation";
  ...
  function handless(e) {
      ...
      newEmergency[e.target.id] = e.target.value
...
<ul>
<li>
  <Link to="/" > <i className="fa fa-camera-retro" aria-hidden="true"></i> Dashboard </Link> 
</li>
<li>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                 onChange={(e) => handle(e)}value={data.firstname} placeholder='First Name' id='firstname' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                 onChange={(e) => handle(e) }value={data.lastname} placeholder='Last Name' id='lastname' required />
            </div>
        </div>
    </div>
</div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="date" className="form-control" 
                  onChange={(e) => handle(e) }value={data.dateofbirth} placeholder='Date of Birth' id='dateofbirth' required  />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <select class="form-select" aria-label="Default select example" 
                 onChange={(e) => handle(e) }value={data.gender} id='gender' required >
                  <option ></option>
                  <option >Male</option>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                 onChange={(e) => handle(e) }value={data.nationality} placeholder='Nationality' id='nationality' 
                 required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <select class="form-select" aria-label="Default select example"
                 onChange={(e) => handle(e) }value={data.martialstatus} id='martialstatus' placeholder='Marital Status'
                  required>
                  <option ></option>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <select class="form-select" aria-label="Default select example"
                 onChange={(e) => handle(e) }value={data.languagespoken} id='languagespoken' placeholder='Languages Spoken' 
                 required>
                  <option ></option>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="file" className="form-control" 
                 onChange={(e) => handle(e) }value={data.employeephoto}  id='employeephoto' required 
                 />
            </div>
        </div>
    </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"
                 onChange={(e) => handles(e) }value={contacts.address} id='address' placeholder='Address' required
                  />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                 onChange={(e) => handles(e)} id='alternateaddress' value={contacts.alternateaddress}
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                onChange={(e) => handles(e)}value={contacts.phonenumber} id='phonenumber' placeholder='Phone Number'
                 required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                 onChange={(e) => handles(e)} value={contacts.emailaddress} id='emailaddress' placeholder='Email Address'
                  required />
            </div>
        </div>
    </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"
                 onChange={(e) => handles(e)} id='linkedinprofileurl' value={contacts. linkedinprofileurl} placeholder='LinkedIn Profile URL'
                  required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="number" className="form-control"
                 onChange={(e) => handles(e)} id='whatsappnumber' value={contacts.whatsappnumber} placeholder='WhatsApp Number'
                  required />
            </div>
        </div>
    </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" 
                onChange={(e) => handles(e)} id='preferredcontactmethod' value={contacts.preferredcontactmethod} placeholder='Preferred Contact Method'
                 required />
            </div>
        </div>
    </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handless(e)} id='contactname' value={emergency.contactname} placeholder='Contact Name'
                 required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"  onChange={(e) => handless(e)} id='relationship' value={emergency.relationship} placeholder=' Relationship' required />
            </div>
        </div>
    </div>
</div>
...
<div className="">
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input1">Phone Number </label>
                <input type="number" className="form-control" onChange={(e) => handless(e)} id='phonenumber' value={emergency.phonenumber} placeholder='Phone Number'required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2">Email Address</label>
                <input type="text" className="form-control" onChange={(e) => handless(e)} id='emailaddress' value={emergency.emailaddress} placeholder='Email Address'required />
            </div>
        </div>
    </div>
</div>
